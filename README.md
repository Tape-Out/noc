...
Network on chip: point-to-point, crossbar, ring and mesh topologies.
...
Planned, not started. Work starts when cores and memory need an interconnect other than a bus.
